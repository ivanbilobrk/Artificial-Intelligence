...
def execute(path_to_solution, language, arguments):
  ...
  if language == 'python':
    ...
    ex_cmd = 'java -cp target/classes:/home/ivan/.m2/repository/org/apache/commons/commons-math3/3.6.1/commons-math3-3.6.1.jar -Dfile.encoding=UTF-8 ui.Solution' if os.name != 'nt' \
      else 'java -cp target/classes:/home/ivan/.m2/repository/org/apache/commons/commons-math3/3.6.1/commons-math3-3.6.1.jar -Dfile.encoding=UTF-8 ui.Solution'
    command = ex_cmd + ' ' + arguments
